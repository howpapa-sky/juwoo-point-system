...
- [x] getLoginUrl 함수 /login으로 리다이렉트 수정 (Invalid URL 오류 해결)
...
## 모든 페이지 실제 기능 구현 (완료)
- [x] EnglishLearning.tsx 완전 구현
  - [x] 카테고리별 단어 목록 표시
  - [x] 플래시카드 학습 모드
  - [x] 객관식 퀴즈 모드 (4지선다)
  - [x] 학습 진도 추적
  - [x] 정답 시 포인트 적립 (50포인트, 처음 맞췤 때만)
- [x] Goals.tsx 완전 구현
  - [x] 목표 목록 표시 (진행 중 / 달성 완료)
  - [x] 새 목표 추가 (제목, 설명, 목표 포인트, 마감일)
  - [x] 진행률 표시 (프로그레스 바)
  - [x] 목표 달성 처리
- [x] Badges.tsx 완전 구현
  - [x] 배지 목록 표시
  - [x] 획듍한 배지 표시
  - [x] 미획듍 배지 표시
- [x] Statistics.tsx 간단한 버전 (준비 중)
- [x] AdminPanel.tsx 간단한 버전 (준비 중)
- [x] AdminSettings.tsx 간단한 버전 (준비 중)
- [x] MyPage.tsx 간단한 버전 (준비 중)
- [x] 빌드 테스트 성공
- [ ] GitHub 푸시 및 Netlify 배포
- [ ] 전체 기능 테스트

## 모든 페이지 브라우저 접속 및 오류 체크 (진행 중)
- [ ] / (홈) - 접속 및 오류 체크
- [ ] /login (로그인) - 접속 및 오류 체크
- [ ] /signup (회원가입) - 접속 및 오류 체크
- [ ] /dashboard (대시보드) - 접속 및 오류 체크
- [ ] /points-manage (포인트 관리) - 접속 및 오류 체크
- [ ] /shop (상점) - 접속 및 오류 체크
- [ ] /transactions (거래내역) - 접속 및 오류 체크
- [ ] /english (영어 학습) - 접속 및 오류 체크
- [ ] /goals (목표) - 접속 및 오류 체크
- [ ] /badges (배지) - 접속 및 오류 체크
- [ ] /statistics (통계) - 접속 및 오류 체크
- [ ] /admin (관리자) - 접속 및 오류 체크
- [ ] /admin/settings (관리자 설정) - 접속 및 오류 체크
- [ ] /mypage (마이페이지) - 접속 및 오류 체크
- [ ] 발견된 모든 오류 목록 작성
- [ ] 모든 오류 수정
- [ ] Statistics 페이지 완전 구현
- [ ] AdminPanel 페이지 완전 구현
- [ ] AdminSettings 페이지 완전 구현
- [ ] MyPage 페이지 완전 구현
- [ ] 전체 기능 재테스트
- [ ] 최종 배포


## Supabase Auth 인증 문제 해결 (완료)
- [x] 인증 상태 불일치 문제 분석
- [x] Supabase getSession() 타임아웃 문제 발견
- [x] users 테이블 id 타입 불일치 문제 발견 (INTEGER vs UUID)
- [x] 역할 조회 로직 제거 및 기본값 사용
- [x] SupabaseAuthContext 완전 재작성
- [x] onAuthStateChange 우선 사용
- [x] 모든 페이지 정상 작동 확인
- [x] 회원가입 및 로그인 기능 테스트 완료
- [x] 대시보드 페이지 정상 작동 확인
- [x] 영어 학습 페이지 정상 작동 확인
